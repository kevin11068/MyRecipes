...
class ChefTest < ActiveSupport::TestCase
    ...
    test "email validation should accept valid addresses" do
        valid_addresses = %w[user@eee.com R_TDD-DS@eee.hello.org user@example.com laura+john@monk.cm]
    ...
    test "email validation should reject invalid addresses" do
        invalid_addresses = %w[user@eee,com R_TDD-DS_at_eee.hello.org user@example. foo@eee+aar.cm]
